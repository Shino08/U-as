...
export function HeroSpotlight() {
  ...
  return (
    <section
      ...
      className="hero-spotlight relative h-screen w-full select-none overflow-hidden"
      style={{
    ...
    >
      ...
      <div
        className="relative z-10 w-full h-full pointer-events-none flex flex-col justify-center px-6 sm:px-10 md:px-16 lg:px-20 pt-16 max-w-7xl mx-auto"
        style={{ color: "#E8E0D2" }}
      >
        <div className="max-w-2xl">
          ...
          <p className="font-mono text-xs md:text-sm tracking-[0.12em] mt-6 opacity-70">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8 pointer-events-auto">
            <a
              href="#reserva"
              className="inline-flex items-center justify-center gap-3 px-8 py-3.5 rounded-full bg-gradient-to-r from-[#d9487d] to-[#f29ebb] text-white font-bold text-xs uppercase tracking-wider shadow-xl shadow-[#d9487d]/25 hover:scale-105 active:scale-95 transition-all"
            >
            ...
            <a
              href="#lookbook"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full border border-[#E8E0D2]/30 bg-black/40 backdrop-blur-sm text-[#E8E0D2] text-xs font-semibold hover:border-[#d9487d] hover:bg-[#d9487d]/20 transition-all"
            >
